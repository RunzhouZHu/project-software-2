...
def unreciveTasks():
    ...
    playerId = param['player_id']
    res = db.getResultList(
        f"select b.task_id,b.task_name,b.task_first_location,b.start,b.end,b.task_team_sign,b.task_amount,b.task_mileage,b.task_content,b.task_sort,b.version,b.next_task,b.before_task from task b where task_id not in (select task_id from player_task where player_id={playerId})")
    return {"result": res}
